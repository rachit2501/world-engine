...
<Callout type={"warning"}>
    Read handler functions should NOT modify state. State should only be modified in <Link href="/docs/pages/cardinal/API-Reference/Systems">Systems</Link>.
</Callout>
...
<Callout type={"warning"}>
    Not all Go types are supported when using EVM supported reads. <Link href="/docs/pages/cardinal/API-Reference/evm-support">Read More</Link>
</Callout>
